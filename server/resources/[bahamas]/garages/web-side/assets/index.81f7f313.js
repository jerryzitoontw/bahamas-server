...
`,
  P0 = {
    COLORS: {
      ...
      YELLOW_10: "rgb(245 10 70 / .1)",
      YELLOW_20: "rgb(245 10 70 / .2)",
      YELLOW_40: "rgb(245 10 70 / .4)",
      YELLOW_60: "rgb(245 10 70 / .6)",
      YELLOW_80: "rgb(245 10 70 / .8)",
      YELLOW_100: "rgb(245 10 70 / .8)",
    },
  };
...
`,
  jc = me.button` 
    ...
    color: ${(e) =>
      e.city ? "rgba(245, 10, 70, 1)" : "rgba(245, 10, 70, 1)"};
  ...
  const { vehicle: t } = Dp(),
    n = (i) => {
      ...
      mn("takeVehicle", o).catch(() => {
        console.log('Error in fetch to callback: "retireVehicle"');
      });
    },
    r = () => {
      mn("storeVehicle").catch(() => {
        console.log('Error in fetch to callback: "keepVehicle"');
      });
    };
  return Te(_0, {
    children: [
      ...
      G(jc, { city: e === "candy", onClick: () => r(), children: "GUARDAR" }),
    ],
  });
}
var O0 = "./assets/background.485be87f.png",
  M0 = "./assets/background-candy.d18d7f19.png";
const N0 = me.main`
    width: 100vw;
    height: 100vh;

    background: url(${(e) => (e.city === "candy" ? M0 : O0)});
...
`,
  ...
  aS = me.button` 
    ...
    background: ${(e) =>
      e.city ? "rgba(0, 0, 0, 0.6)" : "rgba(0, 0, 0, 0.6)"};
    ...
    svg {
        ...
        stroke: ${(e) =>
          e.city ? "rgba(255, 255, 255, 0.6)" : "rgba(255, 255, 255, 0.6)"};
    }

    :hover {
        background: ${(e) =>
          e.city ? "rgba(245, 10, 70, 0.4)" : "rgba(245, 10, 70, 0.4)"};
...
`,
  VS = me(DS)` 
    ...
    background: ${(e) =>
      e.city ? "rgba(0, 0, 0, 0.8)" : "rgba(0, 0, 0, 0.8)"};
  ...
  const t = xS.baseImagesURL,
    ...
    r = () => {
      mn("taxVehicle", n).catch(() => {
        console.log('Error in fetch to callback: "buyTax"');
      });
    },
    i = () => {
      mn("sellVehicle", n).catch(() => {
        console.log('Error in fetch to callback: "sellVehicle"');
      });
    },
    o = () => {
      mn("transferVehicle", n).catch(() => {
        console.log('Error in fetch to callback: "transferVehicle"');
      });
    };
  return Te(cS, {
    active: e.active,
