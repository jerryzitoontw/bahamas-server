...
-- SPAWNPOSITION
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.SpawnPosition(Select)
	local Slot = "0"
	local Checks = 0
	local Selected = {}
	local Position = nil
...
-- CREATEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.CreateVehicle(Model,Network,Engine,Health,Customize,Windows,Tyres)
...
-- SEARCHBLIP
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.SearchBlip(Coords)
...
-- STARTHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.StartHotwired()
	Hotwired = true
...
-- STOPHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.StopHotwired(Vehicle)
	Hotwired = false
...
-- UPDATEHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function Bahamas.UpdateHotwired(Status)
	Hotwired = Status
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOOPHOTWIRED
