vehicleCustomisationPrices = {
	cosmetics = 1250,
	respray = 1250,
	engines = { 5000, 11000, 20000, 30000, 43000, 53000 },
	brakes = { 7000, 16000, 27000, 37000, 40000, 57000 },
	transmission = { 7000, 27000, 27000, 39000, 49000, 59000 },
	suspension = { 5000, 12000, 21000, 31000, 41000, 51000 },
	shield = { 20000, 40000, 60000, 80000, 100000, 120000 },
	turbo = 7250,
	wheels = 1250,
	customwheels = 1250,
	wheelsmoke = 775,
