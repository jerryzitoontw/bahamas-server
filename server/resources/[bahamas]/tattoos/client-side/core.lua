...
function openTattooShop()
	...
	elseif GetEntityModel(Ped) == GetHashKey("mp_f_freemode_01") then
		...
		SetPedComponentVariation(Ped,1,-1,0,1)
		SetPedComponentVariation(Ped,3,15,0,1)
		SetPedComponentVariation(Ped,4,21,0,1)
		SetPedComponentVariation(Ped,5,-1,0,1)
...
-----------------------------------------------------------------------------------------------------------------------------------------
local Locations = {
	{ 1321.46,-1653.91,52.27 },
	{ -1155.66,-1427.18,4.95 },
	{ 324.47,180.0,103.59 },
	{ -3169.29,1077.59,20.83 },
	{ 1864.45,3746.73,33.03 },
...
CreateThread(function()
	...
	for Number = 1,#Locations do
		Tables[#Tables + 1] = { Locations[Number][1],Locations[Number][2],Locations[Number][3],2.0,"E","Loja de Roupas","Pressione para abrir" }
	end
